...
class BARINEL_Combo(BARINEL):
    ...
    def get_diagnoses(self,
        ...
        if self.diagnoses is None:
            self.diagnoses = super().get_diagnoses(retrieve_ranks=True)
            ...
            for diagnosis_index, (diagnosis, _) in enumerate(self.diagnoses):
                ...
                self.diagnoses[diagnosis_index] = (diagnosis, features_ranks_sum / features_diagnoses_count)
            self.sort_diagnoses()

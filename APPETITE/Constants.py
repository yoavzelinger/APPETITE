...
DEFAULT_FIXING_DIAGNOSER = ("STAT_SFLDT", "BARINEL_Features", "BARINEL_Paths_After", "STAT_BARINEL_Paths_After", "BARINEL_Paths_Difference", "STAT_BARINEL_Paths_Difference")
...
BARINEL_PATHS_TYPE = "AFTER" # in ["AFTER", "DIFFERENCE"]

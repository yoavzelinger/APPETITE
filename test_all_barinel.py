...
aggregated_results.to_csv(f"{RESULTS_FULL_PATH}/BARINEL_Paths_aggregated_results.csv", index=False)
raw_results.to_csv(f"{RESULTS_FULL_PATH}/BARINEL_Paths_all_results.csv", index=False)
if not errors.empty:

...
RESULTS_FUZZY_PARTICIPATION_FILE_NAME = f"{RESULTS_FILE_NAME_PREFIX}_{FUZZY_PARTICIPATION_PREFIX}"
ERRORS_FUZZY_PARTICIPATION_FILE_NAME = f"{RESULTS_FILE_NAME_PREFIX}_{FUZZY_PARTICIPATION_PREFIX}"

...
DEFAULT_FIXING_DIAGNOSER = ("STAT_SFLDT", "BARINEL", "BARINEL_Paths_After", "STAT_BARINEL_Paths_After", "BARINEL_Paths_Difference", "STAT_BARINEL_Paths_Difference", "BARINEL_Features", "BARINEL_Features_Paths_After", "BARINEL_Features_Paths_Difference", "SFLDT_Features")
